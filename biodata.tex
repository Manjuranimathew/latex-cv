...
\leftheader{%
  {\LARGE\bfseries\sffamily Ms. ~Lekshmi M S}

  \makefield{\faEnvelope[regular]}{\href{nasreenali@icet.ac.in}{\texttt{lakshmims101982@gmail.com}}}
  % \makefield{\faTwitter}{\href{https://twitter.com/overleaf_example}{\texttt{@overleaf\_example}}}
  \makefield{\faLinkedin}
  {\href{https://in.linkedin.com/in/nasreen-ali-896218221}{\texttt{Lekshmi M S}}}

  %% Next line
 % \makefield{\faGlobe}{\url{https://www.icet.ac.in/faculties/4/staff-profile}}
